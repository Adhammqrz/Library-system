...
void eventinformation()
{
    ...
    do
    {
        ...
        case 1:
            ...
            break;
        case 2:
            print_by_event_type("Workshops");
            break;
        case 3:
            print_by_event_type("Community Programs");
            break;
        case 4:
            printf("\n\n==============");
            printf("\n Exiting....");
...
// Function to print events by type
void print_by_event_type(const char *eventtype)
{
    ...
    while (fgets(line, sizeof(line), file))
    {
        ...
        if (strcasecmp(events.eventname, eventtype) != NULL)
        {
    ...
    if (found)
    {
        do
        {
            printf("\n\nAre you interested in joining? (y/n): ");
            scanf(" %c", &choice);
