...
void titleorauthor()
{
    ...
    do
    {
        ...
        if (!found) {
            ...
            printf("\nPlease verify the inputs that have been inserted are exactly the same as in the original book.\n");
        }
...
void booksummary()
{
    ...
    do{
        ...
        {
            printf("\nNo matching books found.");
            printf("\nPlease verify the book title that have been inserted are exactly same from the Book List.\n");
        }
...
void eventdetails()
{
    ...
    do{
        ...
        {
            printf("\nNo Event Finding.\n");
            printf("Please verify the event name that have been inserted are exactly the same as in the event list.\n");
        }
...
void print_by_event_type(const char *eventtype)
{
    ...
    do {
        ...
        if (choice != 'y' && choice != 'Y' && choice != 'n' && choice != 'N') {
            ...
            printf("Website Link: www.jrlibrary.com.my\n");
            return;
        } else {
            return;
        }
